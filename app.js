...
app.get('/profile', isAuthenticated, (req, res) => {
    // req.session.username'i EJS şablonuna gönder
    // Eğer session'da yoksa veya null ise 'Kullanıcı' dönsün
    res.render('profile.ejs', { username: req.session.username || 'Kullanıcı' });
});
